 ...
 */
  public static class TokenizerMapper
	  ...
	  static double idfThreshold=30000;	//change this threshold according to the dataset; we set to 1000 for tiny, and scale linearly
  ...
  public static class IntSumReducer
	...
	public static HashMap<String, Integer> tokenizeJSONAndReturnTFs(String json){
		...
		public void reduce(Text key, Iterable<Text> values,
	      ...
	      HashMap<Integer, Long> jaccardBins=new HashMap<Integer, Long>();
	      for(int i=0; i<=10; i++)
	    	  jaccardBins.put(i, (long)0);
	      ...
	      for(String d1: dataset1){
	    	  ...
	    	  for(String d2: dataset2){
	    		  ...
	    		  int bin=(int) Math.floor(jaccard*10);
	    		  jaccardBins.put(bin, jaccardBins.get(bin)+1);
	    	  }
	      }
	      String result=new String("");
	      for(int i=0; i<10; i++)
	    	  result+=(Long.toString(jaccardBins.get(i))+"\t");
	      result=result.substring(0, result.length()-1);
	      context.write(new Text(result), new Text(Long.toString(jaccardBins.get(10))));
	    }
	  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = new Job(conf, "census: TSG-1");
    job.setJarByClass(TSG1.class);
