...
public class DbpediaAppendTypesYago {
/**
 * Meant for taking the Dbpedia curated_instance-types and the curated_yago_links and
 * returning a file of the format:
 * <idz>[tab]<yago-entity1>...<dbpedia-type1>[tab]<dbpedia-type2>...
 * 
 ...
 */
  ...
  public static class IntSumReducer
	  ...
	  public void reduce(Text key, Iterable<Text> values,
	     ...
	     for (Text val : values) {
	        ...
	        if(k.contains("dbpedia.org/ontology"))
	        	types.add(k);
	        else
	        	yagoEntities.add(k);
	     ...
	     if(yagoEntities.size()==0||types.size()==0)
	    	 return;
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = new Job(conf, "append types of dbpedia resources and yago entities");
    job.setJarByClass(DbpediaAppendTypesYago.class);
