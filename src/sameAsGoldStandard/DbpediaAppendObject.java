...
public class DbpediaAppendObject {
/**
 * Meant for taking the Dbpedia withTypes and the curated_freebase_links and
 * returning a file of the format:
 * <idx>[tab]<freebase-entity>[tab]"dbpedia-instance"[tab]<dbpedia-json-object>
 * 
 ...
 */
  ...
  public static class IntSumReducer
	  ...
	  public void reduce(Text key, Iterable<Text> values,
	     ...
	     if(freebaseEntities.size()==0||res.equals("dbpedia-instance\t"))
	    	 return;
  ...
  public static void main(String[] args) throws Exception {
    ...
    Job job = new Job(conf, "append dbpedia resources and freebase entities");
    job.setJarByClass(DbpediaAppendObject.class);
